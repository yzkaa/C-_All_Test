...
QT_MOC_LITERAL(1, 13, 10), // "windowShow"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10) // "windowHide"

    },
    "SecondWindow\0windowShow\0\0windowHide"
};
...
void SecondWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->windowShow(); break;
        case 1: _t->windowHide(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SecondWindow::windowShow)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SecondWindow::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SecondWindow::windowHide)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SecondWindow::windowShow()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SecondWindow::windowHide()
{
