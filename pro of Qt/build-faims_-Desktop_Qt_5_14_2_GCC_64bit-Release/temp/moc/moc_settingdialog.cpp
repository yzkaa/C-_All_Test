...
#include <memory>
#include "../../../faims_/settingdialog.h"
...
QT_MOC_LITERAL(3, 21, 11), // "connectIsOK"
QT_MOC_LITERAL(4, 33, 12), // "showPortInfo"
QT_MOC_LITERAL(5, 46, 3), // "idx"
QT_MOC_LITERAL(6, 50, 5), // "apply"
QT_MOC_LITERAL(7, 56, 25), // "checkCustomBaudRatePolicy"
QT_MOC_LITERAL(8, 82, 27), // "checkCustomDevicePathPolicy"
QT_MOC_LITERAL(9, 110, 10), // "Timer_Init"
QT_MOC_LITERAL(10, 121, 23) // "on_searchButton_clicked"

    },
    "SettingDialog\0ready\0\0connectIsOK\0"
    "showPortInfo\0idx\0apply\0checkCustomBaudRatePolicy\0"
    "checkCustomDevicePathPolicy\0Timer_Init\0"
...
void SettingDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingDialog::ready)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SettingDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingDialog::connectIsOK)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SettingDialog::ready()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SettingDialog::connectIsOK()
{
