...
#include <memory>
#include "../../../../../pro_of_Qt/faims_04-08/faims_/UDP/networkserver.h"
...
QT_MOC_LITERAL(1, 14, 18), // "getCalculationData"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 15), // "QList<QPointF>&"
QT_MOC_LITERAL(4, 50, 4), // "data"
QT_MOC_LITERAL(5, 55, 19), // "readSettingsAndBind"
QT_MOC_LITERAL(6, 75, 14) // "receiveResults"

    },
    "NetworkServer\0getCalculationData\0\0"
    "QList<QPointF>&\0data\0readSettingsAndBind\0"
    "receiveResults"
};
...
void NetworkServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->readSettingsAndBind(); break;
        case 2: _t->receiveResults(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NetworkServer::*)(QList<QPointF> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkServer::getCalculationData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NetworkServer::getCalculationData(QList<QPointF> & _t1)
{
