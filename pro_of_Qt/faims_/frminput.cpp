...
void frmInput::InitForm()
{
    ...
    qDebug() << "deskWidth:" << deskWidth;
    deskHeight = w.availableGeometry().height();
    qDebug() << "deskHeight:" << deskHeight;
    frmWidth = this->width();
    qDebug() << "frmWidth:" << frmWidth;
    frmHeight = this->height();
    qDebug() << "frmHeight:" << frmHeight;
...
void frmInput::InitProperty()
{
    ...
    ui->btnOther1->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther2->setProperty("btnOther", true);
    ui->btnOther2->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther3->setProperty("btnOther", true);
    ui->btnOther3->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther4->setProperty("btnOther", true);
    ui->btnOther4->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther5->setProperty("btnOther", true);
    ui->btnOther5->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther6->setProperty("btnOther", true);
    ui->btnOther6->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther7->setProperty("btnOther", true);
    ui->btnOther7->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther8->setProperty("btnOther", true);
    ui->btnOther8->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther9->setProperty("btnOther", true);
    ui->btnOther9->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther10->setProperty("btnOther", true);
    ui->btnOther10->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther11->setProperty("btnOther", true);
    ui->btnOther11->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther12->setProperty("btnOther", true);
    ui->btnOther12->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther13->setProperty("btnOther", true);
    ui->btnOther13->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther14->setProperty("btnOther", true);
    ui->btnOther14->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther15->setProperty("btnOther", true);
    ui->btnOther15->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther16->setProperty("btnOther", true);
    ui->btnOther16->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther17->setProperty("btnOther", true);
    ui->btnOther17->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther18->setProperty("btnOther", true);
    ui->btnOther18->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther19->setProperty("btnOther", true);
    ui->btnOther19->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther20->setProperty("btnOther", true);
    ui->btnOther20->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnOther21->setProperty("btnOther", true);
    ui->btnOther21->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");

    ui->btnDot->setProperty("btnOther", true);
    ui->btnDot->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnSpace->setProperty("btnOther", true);
    ui->btnSpace->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnEnter->setProperty("btnOther", true);
    ui->btnEnter->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnDelete->setProperty("btnOther", true);
    ui->btnDelete->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");

    ui->btn0->setProperty("btnNum", true);
    ui->btn0->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}"
                     );
    ui->btn1->setProperty("btnNum", true);
    ui->btn1->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn2->setProperty("btnNum", true);
    ui->btn2->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn3->setProperty("btnNum", true);
    ui->btn3->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn4->setProperty("btnNum", true);
    ui->btn4->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn5->setProperty("btnNum", true);
    ui->btn5->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn6->setProperty("btnNum", true);
    ui->btn6->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn7->setProperty("btnNum", true);
    ui->btn7->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn8->setProperty("btnNum", true);
    ui->btn8->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn9->setProperty("btnNum", true);
    ui->btn9->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btn00->setProperty("btnNum", true);
    ui->btn00->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");

    ui->btna->setProperty("btnLetter", true);
    ui->btna->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnb->setProperty("btnLetter", true);
    ui->btnb->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnc->setProperty("btnLetter", true);
    ui->btnc->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnd->setProperty("btnLetter", true);
    ui->btnd->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btne->setProperty("btnLetter", true);
    ui->btne->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnf->setProperty("btnLetter", true);
    ui->btnf->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btng->setProperty("btnLetter", true);
    ui->btng->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnh->setProperty("btnLetter", true);
    ui->btnh->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btni->setProperty("btnLetter", true);
    ui->btni->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnj->setProperty("btnLetter", true);
    ui->btnj->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnk->setProperty("btnLetter", true);
    ui->btnk->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnl->setProperty("btnLetter", true);
    ui->btn1->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnm->setProperty("btnLetter", true);
    ui->btnm->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnn->setProperty("btnLetter", true);
    ui->btnn->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btno->setProperty("btnLetter", true);
    ui->btno->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnp->setProperty("btnLetter", true);
    ui->btnp->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnq->setProperty("btnLetter", true);
    ui->btnq->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnr->setProperty("btnLetter", true);
    ui->btnr->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btns->setProperty("btnLetter", true);
    ui->btns->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnt->setProperty("btnLetter", true);
    ui->btnt->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnu->setProperty("btnLetter", true);
    ui->btnu->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnv->setProperty("btnLetter", true);
    ui->btnv->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnw->setProperty("btnLetter", true);
    ui->btnw->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnx->setProperty("btnLetter", true);
    ui->btnx->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btny->setProperty("btnLetter", true);
    ui->btny->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnz->setProperty("btnLetter", true);
    ui->btnz->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnPre->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                                "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnDelete->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                                 "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnNext->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                               "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnl->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                            "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
    ui->btnType->setStyleSheet("QPushButton{background:#e6f0fa;border:2px groove gray;border-radius:10px;padding:2px 4px}"
                               "QPushButton:pressed{background:#e6f0fa;border:2px;border-radius:10px;padding:2px 4px}");
...
{
    qDebug() << "oldWidget:" << oldWidget;
    qDebug() << "nowWidget:" << nowWidget;
    if (nowWidget != 0 && !this->isAncestorOf(nowWidget)) {
        ...
        if (nowWidget->inherits("QLineEdit")) {
            ...
            ShowPanel();
        } else if (nowWidget->inherits("QFileDialog")) {
